...
//@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/jobseeker2")
@Slf4j
public class JobSeekerController2 {
	...
	@PostMapping(value = "/jobseeker2/files/{id}", consumes = "multipart/form-data")
